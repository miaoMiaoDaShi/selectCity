...
public class Lunar {
    ...
    private final static String chineseWeek[] = {"一", "二", "三", "四", "五", "六", "日"};
...
//        final String[] Animals = new String[]{"鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊", "猴", "鸡", "狗", "猪"};
    ...
    public String getChineseWeek(int day){
        return chineseWeek[day-2];
    }
    ...
    public SparseArray<Integer> getLunar(){
        SparseArray<Integer> sparseArray = new SparseArray<Integer>();
        sparseArray.put(0,year);
        sparseArray.put(1,month-1);
